...
const HeaderMenuItem = (props : HeaderMenuItemProps) => {
    return (
        <div className={`flex flex-col 
                        custom-2xl:mr-10 xl:mr-5 lg:mr-10 font-500 text-[16px] justify-center items-center ${props.active ? 'text-[#29B080]' :'text-[#929298]'} h-full cursor-pointer hover:text-[#29B080] select-none`} onClick={props.onClick}>
