...
const DaoPanel = (props: DaoPanelProps) => {
    return (
        <div
            className={`relative w-full rounded-[20px] border-[1.5px] ${
                props.selected ? 'border-primary' : 'border-white/10'
            } z-10 bg-transparent m-auto hover:border-primary hover:cursor-pointer`}
        ...
        >
            ...
            <div className="relative text-center mb-2">
                <span className="text-[14px] text-[#f3f3f3]">
                    {props.title}
                </span>
            </div>
            <div
                className={`top-[6px] left-[6px] sm:top-[12px] sm:left-[12px] ${
