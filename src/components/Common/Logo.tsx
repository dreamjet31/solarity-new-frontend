...
const Logo = () => {
  return (
    <div>
      <a href="#" className="items-center py-3 px-2 text-white justify-center hidden sm:flex">
      ...
      <a href="#" className="flex items-center py-3 px-2 text-white justify-center sm:hidden">
