    ...
    return (
        <div className="relative w-full h-[52px] flex border-[1.2px] border-primary rounded-[15px]">
            ...
            <div className="flex w-[70%] justify-center items-center">
                <input type="text" className="w-full bg-transparent font-400 text-[#f3f3f3] text-[16px] px-[16px] border-r-[1.5px] border-r-[#272829] box-border" value={eventInfo.title} onChange={(e) => onChageRoomTitle(e)} autoFocus={true} />
            </div>
