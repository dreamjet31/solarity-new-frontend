...
const UserInfoMenu = (props) => {
    ...
    const displayDetailNotification = () => {
    ...
    return (
        <div className="select-none flex flex-row items-center border-l-semiSplitter border-l-[1px] h-full ">
            <div
                className="custom-2xl:mx-[20px] xl:mx-[10px] lg:mx-[20px] md:mx-[20px] xs:mx-[20px]
                            cursor-pointer relative"
                onClick={displayDetailNotification}
            >
                <svg
                ...
                {alarm != 0 && (
                    <div className="absolute top-[-2px] right-[-4px] rounded-full py-[2px] px-[4px] bg-[#29B080] text-[11px] leading-[11px]">
                        {alarm}
                    </div>
                )}
            </div>
            <Link href={`/${profileData.username}/profile`}>
                <a>
                    ...
                    profileData.profileImage.link ? (
                        <div className="min-h-[40px]">
                            <img
                                src={profileData.profileImage.link}
                                width={40}
                                style={{ height: '40px' }}
