...
const RoomMemberAvatarSmall = (props: RoomMemberAvatarSmallType) => {
    return (
        <div className={`border-[3px] border-[#131314] ${props.type == 2 ? 'h-[30px] w-[30px] box-content ml-[-10px] rounded-[12px]': 'h-[40px] w-[40px] box-content ml-[-17px] rounded-[18px]'} relative overflow-hidden`}>
