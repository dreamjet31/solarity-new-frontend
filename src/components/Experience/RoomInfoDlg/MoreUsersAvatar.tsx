...
const MoreUsersAvatar = (props : MoreUsersAvatarType) => {
    return (
        <div className={`border-[3px] border-[#131314] ${props.type == 2 ? 'rounded-[12px] h-[30px] w-[30px] box-content ml-[-10px]': 'rounded-[18px] h-[40px] w-[40px] box-content ml-[-17px]'} relative
