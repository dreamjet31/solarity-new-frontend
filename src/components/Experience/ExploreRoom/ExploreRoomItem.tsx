  ...
  return (
    <div
      className={`flex flex-col w-[100%] h-fit border-[1.2px] border-[#272829] rounded-[20px] p-[8px]
                        relative cursor-pointer hover:border-primary custom-2xl:col-span-3 xl:col-span-4 lg:col-span-6 xs:col-span-6 ${(selectedRoom.no == props.roomNo && selectedRoom.type == props.type) ? 'border-primary' : ''}`}
