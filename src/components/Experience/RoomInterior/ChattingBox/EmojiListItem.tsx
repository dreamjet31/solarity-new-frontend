...
const EmojiListItem = (props : EmojiListItemType) => {
    ...
    const feedEmoji = () => {
        let input_comp = document.getElementById("chatting_input")
    ...
    return (
        <div className={` cursor-pointer flex flex-row justify-center items-center bg-transparent hover:bg-[#3f3f43] rounded-[5px] p-[2px] `} onClick={() => feedEmoji()} >
            <div>
                {props.item}
            </div>
        </div>
