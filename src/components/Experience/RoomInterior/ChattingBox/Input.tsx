...
const Input = (props : InputType) => {
    ...
    const enterKeyCapture = (e) => {
        ...
        if((e.keyCode === 13 && e.shiftKey) || (e.keyCode === 13 && e.ctrlKey)) {
            ...
            e.target.value = prevState.substring(0, start) + "\n" + prevState.substring(end);
            document.getElementById("chatting_input_container").style.height = (e.target.scrollHeight + 28)+"px"
    ...
    const makeParentHeightGrowAsMe = (arg) => {
        document.getElementById("chatting_input_container").style.height = (arg + 28)+"px"
    }
    ...
    return (
        <div className={` flex flex-row h-[52px] rounded-[15px] border-[1.2px] ${props.focusState ? "border-primary" : "border-[#272829]" } mx-[26px] px-[16px] py-[18px]
                           absolute bottom-[32px] w-[85%] justify-between items-start gap-[12px] bg-globalBgColor `} id="chatting_input_container" >
            <div className="flex cursor-pointer" onClick={() => getReadyUpload()}>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.6668 6.66671V10C14.6668 13.3334 13.3335 14.6667 10.0002 14.6667H6.00016C2.66683 14.6667 1.3335 13.3334 1.3335 10V6.00004C1.3335 2.66671 2.66683 1.33337 6.00016 1.33337H9.3335" stroke="#929298" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M14.6668 6.66671H12.0002C10.0002 6.66671 9.3335 6.00004 9.3335 4.00004V1.33337L14.6668 6.66671Z" stroke="#929298" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            ...
            <div className="flex w-[70%]">
                <TextareaAutosize 
                    ...
                    id="chatting_input"
                    placeholder="Write something" wrap="hard"
            ...
            <div className="flex cursor-pointer relative" onClick={() => getReadyEmoji()} >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex cursor-pointer " onClick={() => send()}>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.0342 0.839798L1.33424 4.7748C1.09898 4.83724 0.890178 4.97398 0.738899 5.16466C0.58762 5.35534 0.501954 5.58977 0.49465 5.83307C0.487345 6.07636 0.558793 6.31551 0.69836 6.51492C0.837927 6.71433 1.03815 6.86335 1.26924 6.9398L7.02924 8.8698C7.05023 8.87778 7.06944 8.88984 7.08575 8.90529C7.10205 8.92074 7.11513 8.93926 7.12424 8.9598L9.24424 14.4598C9.33003 14.6808 9.48144 14.8701 9.67811 15.0024C9.87477 15.1347 10.1072 15.2036 10.3442 15.1998H10.3742C10.6152 15.199 10.8498 15.1223 11.0446 14.9804C11.2394 14.8386 11.3845 14.6389 11.4592 14.4098L15.4992 2.2798C15.5626 2.08559 15.5718 1.8778 15.526 1.67872C15.4802 1.47964 15.3811 1.2968 15.2392 1.1498C15.0875 0.990515 14.8942 0.877014 14.6811 0.82221C14.4681 0.767406 14.244 0.773499 14.0342 0.839798Z"
