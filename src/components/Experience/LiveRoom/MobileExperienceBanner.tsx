...
const MobileExperienceBanner = () => {
  ...
  const { selectedIndex, rooms, mobileBanner } = useSelector((state: RootStateOrAny) => ({
  ...
  return (
    <div
      className={`${mobileBanner ? "flex" : "hidden"} justify-center fixed top-[0px] bottom-[0px] right-[0px] left-[0px] backdrop-blur-sm w-full h-full z-[2000] touch-none`}
    >
      <div
        ...
        style={{
          backgroundImage: `url(${!!selectedLiveRoom.imageUrl ? selectedLiveRoom.imageUrl : `/images/experience/room_images/room_1.jpg`}`,
        }}
      >
        <div
