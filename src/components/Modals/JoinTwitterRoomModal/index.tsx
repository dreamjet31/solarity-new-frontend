...
const JoinTwitterRoomModal: FC<any> = ({
  type,
  name
}: {
  type: string;
  ...
  return (
    <div
      className={` pt-[12px] px-[32px] pb-[35px] md:items-center backdrop-blur-[20px] md:bg-[rgba(12,12,14,0.7)] xs:bg-globalBgColor z-[1002]`}
      id="room_setting_dlg"
    >
      <div className=" flex flex-row justify-between items-center mb-5">
        ...
        >
          ...
          <div className=" font-['Outfit'] font-[200] text-[12px] text-[#f3f3f3] pt-[2px] ">
            {selectedLiveRoom.avatars && selectedLiveRoom.avatars.length}
          </div>
        </div>
      </div>
      <div className="grid grid-cols-5 gap-4">
        ...
        <div
          className=" col-span-3 md:w-[22%] xs:w-full h-[100%] bg-[#131314]
                        flex flex-col gap-[16px] overscroll-contain"
        >
          <Input value={username} setValue={setUsername} caption={"Your nickname"} disabled={false} />
          {/* begin of avatar list------------------------------------------------------------------------------------------------ */}
          {/* <div className="relative h-[25%]">
            <div
              className=" grid grid-cols-2 gap-[16px] h-[100%] overflow-y-scroll overflow-x-visible 
                                      pb-[15px] overscroll-contain"
            >
...
export default JoinTwitterRoomModal;
