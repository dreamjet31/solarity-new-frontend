        ...
        <div className="bg-globalBgColor flex sm:flex-row xs:flex-col w-full relative">
            ...
            <div className="bg-globalBgColor w-full">
                ...
                <div className="flex w-full">
                    <div
                        className={`fixed left-[0px] xs:top-[80px] sm:top-[164px] xl:top-[124px] bottom-0 overflow-y-auto ${
                            chatSidebarVisibility ? 'right-[435px]' : 'right-0'
                        }`}
                    >
                        <div
                    ...
                    {chatSidebarVisibility && (
                        <div>
                            ...
                            <Sidebar
                                ...
                                setIsChatPanel={setIsChatPanel}
                            />
                        </div>
                    )}
                </div>
            </div>
            {notificationModalVisibility && <NotificationModal />}
