...
const WalletBalanceIcon = ({kind, balance, address, badge, onClick}) => {
    return (
        <div className="flex
                        ...
                        bg-[#181818] sm:rounded-5 xs:rounded-4 m-[5px] sm:p-4 xs:p-[11px] content-between rounded-[20px] cursor-pointer" onClick={onClick}>
            <div className="flex flex-row justify-start text-[#929298] font-400 min-w-[24px]
