...
const TabGeneralContent = () => {
    return (
        <div className="profile-settings-content h-[496px] min-w-[330px] flex flex-col items-between gap-[32px] mt-8 pt-[2px] pb-[2px] mb-[25px] overflow-y-auto overflow-x-visible items-center">
