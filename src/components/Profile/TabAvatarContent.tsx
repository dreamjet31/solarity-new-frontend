...
const TabAvatarContent = () => {
    return (
        <div className="profile-settings-content h-full min-w-[330px] flex flex-col gap-[32px] mt-8 pt-[5px]  pb-[2px] mb-[40px] overflow-y-auto overflow-x-visible items-center">
            <div className="flex justify-center rounded-[45px] min-h-[130px] min-w-[130px]">
                <Image src="/images/profile/temp/Avatar.png" layout="fixed" width={130} height={130} alt="avatar" />
            </div>
            <div className="social flex flex-col w-full">
                <SettingsFileUpload />
            </div>
            <div className="wallet flex gap-[24px] justify-between w-full pb-[60px]">
                <AvatarPanel imageSrc="/images/profile/profile.png" title="what is this" onClick={() => alert("asdf")}  />
                <AvatarPanel imageSrc="/images/profile/profile.png" title="what is this" onClick={() => alert("asdf")}  />
            </div>
        </div>
    )
