...
const TabAvatarContent = () => {
    return (
        <div className="profile-settings-content h-full min-w-[330px] flex flex-col gap-[32px] mt-8 pt-[5px]  pb-[2px] mb-[40px] overflow-x-visible items-center">
            ...
            <div className="wallet flex gap-[24px] justify-between w-full pb-[60px] overflow-y-auto">
