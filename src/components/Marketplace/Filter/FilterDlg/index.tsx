...
function FilterDlg(props: FilterDlgProps) {
    ...
    return (
        <div className={`flex justify-center top-[0px] left-[0px] right-[0px] items-end bottom-[0px]
                        ...
                        z-[1002] ${props.dlgToggle === true ? "fixed" : "hidden"} `} id="filter_dlg" onClick={(e) => closeDlg(e)}>
            <div className=" fixed md:w-[426px] xs:w-full sm:w-full bg-[#131314] border-t-[1px] border-[#1d1d1f] rounded-[20px]
                            flex flex-col pt-[28px] px-[32px] pb-[32px] gap-[24px] overscroll-contain ">
                <div className="absolute xs:right-[50%] xs:top-[-50px] md:right-[-18px] md:top-[-18px] cursor-pointer xs:m-auto text-[#B3B3B7]" onClick={() => props.setDlgToggle(false)}>
                ...
                <div className=''>
                    <p className='text-center text-[24px] font-[500] text-white'>Filters</p>
                </div>
