...
} from 'modules/Marketplace/MarketplaceBanner'
...
function RoomDlg(props: RoomDlgProps) {
    ...
    return (
        ...
        >
            <div
                className=" fixed md:w-[426px] xs:w-full h-[525px] bg-[#131314] xs:border-t-[1px] md:border-[1px] border-[#1d1d1f] rounded-[20px]
                            flex flex-col pt-[28px] px-[32px] gap-[24px] overscroll-contain "
            >
                <div
                    className="absolute xs:left-1/2 xs:top-[-50px] xs:transform xs:-translate-x-1/2 xs:-translate-y-1/2 md:right-[-18px] md:top-[-18px] cursor-pointer xs:m-auto text-[#B3B3B7]"
