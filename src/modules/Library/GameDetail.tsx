                                    ...
                                    <>
                                        <div className="sm:pl-[20px] lg:pl-[50px]">
                                            ...
                                            <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-[32px] justify-items-center lg:max-h-[400px] overflow-auto sm:pr-[10px]">
                                                {detailData.stores.map(
                                                    (store, index) => (
                                                        <div
                                                            className="bg-[#181818] px-[15px] py-[20px] rounded-[20px] w-[70%] sm:w-full"
                                                            key={index}
                                                        >
                                ...
                                {tabIndex === 2 ? (
                                    <div className="pl-[50px]">
                                        <div className="text-white font-medium py-[20px]">
                                            There are currently no running
                                            experiences.
                                        </div>
                                    </div>
                                ) : null}
                                    ...
                                    <div className="flex flex-col py-[20px] pl-[20px] sm:pl-[50px] w-[80%]">
                                        <div className="flex flex-row justify-between items-center">
                                            ...
                                            <div className="flex flex-row gap-[5px] items-center">
                                                <span className="font-medium text-[14px] text-[#474749] cursor-pointer">
                                                    Sort by
                                                </span>
                                                <ArrowDownIcon />
                                            </div>
                                        ...
                                        <div className="flex flex-row gap-[15px] bg-[#1D1D1E] rounded-[15px] px-[20px] py-[15px] mt-[20px]">
                                            <div>
                                                <Image
                                                    src="/images/library/default_avatar.png"
                                                    height={24}
                                                    width={24}
                                                />
                                            </div>
                                            <div className="flex flex-col w-full">
                                                <input
                                                    ...
                                                    className="bg-transparent text-[#B3B3B7] text-[16px]"
                                                />
                                            ...
                                            detailData.reviews.map(
                                                (review, index) => (
                                                    <div className="flex flex-row gap-[15px] bg-[#1D1D1E] rounded-[15px] px-[20px] py-[15px] mt-[20px]">
                                                        <div>
                                                            <Image
                                                                src="/images/library/temp/users/avatar.png"
                                                                height={24}
                                                                width={24}
                                                            />
                                                        </div>
                                                        <div className="flex flex-col w-full justify-between">
                                                            ...
                                                            <div className="mt-[10px]">
                                                                ...
                                                                {review.content
                                                                    .length >
                                                                150 ? (
                                                                    <span className="text-[16px] text-[#474749] cursor-pointer">
                                                                        more
                                                                    </span>
                                                                ) : null}
                                                            </div>
