...
const MarketplaceBanner = (props: MarketPlaceBannerType) => {
    ...
    return (
        <div
            className={`rounded-[25px] md:bg-[#1A1A1C] md:flex xs:flex md:flex-row xs:flex-col justify-between ${
                props.isDlg ? '' : 'xs:hidden'
            }`}
        >
                        ...
                        {selectedRoom.imgUrl == undefined ? (
                            <div className="flex border border-[#1A1A1C]">
                                <div className="relative w-[50%] h-[496px] bg-[#131314] xl:block hidden">
                                    <Image
                                        src="/images/intro/slides/rooms.png"
                                        layout="fill"
                                    />
                                </div>
                                <div className="xl:w-[50%] w-full h-[496px] bg-[#131314] flex items-center justify-center text-center">
                                    <div>
                                        <h2 className="text-[30px] font-[700] title-color">
                                            ROOMS
                                        </h2>
                                        <p className="center text-[19px] font-[500] content-color">
                                            Virtual Experiences for your friends
                                            and <br />
                                            communities.
                                        </p>
                                    </div>
            ...
            <div className="md:basis-1/4">
                <CollectionInfoDlg
                    buy={selectedRoom.imgUrl ? props.buy : chooseFirstRoom}
                />
            </div>
        </div>
    )
