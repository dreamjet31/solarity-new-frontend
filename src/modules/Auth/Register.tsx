...
export const RegisterPage = () => {
    ...
    const { userInfo, step, isMobile } = useSelector(
                ...
                if (response.data.user) {
                    ...
                    dispatch(
                        updateUserInfo({
                            ...
                            callback: () =>
                                dispatch(
                                    jumpStep({ stepNum: user.registerStep })
                                ),
                        })
                    )
                }
    ...
    return (
        <div
            className={`lg:flex lg:flex-row justify-center md:flex-col gap-[25px] ${
                isMobile ? '' : 'mt-[35px] px-5 sm:px-11'
            } lg:mt-[50px] items-center`}
        >
            {!isMobile ? (
                <>
